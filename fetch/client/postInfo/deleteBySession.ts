...
import {ReqBodyType, ResBodyType} from "@/app/api/client/post-info/by-session/[postId]/delete.type";

export default async function deleteBySession(json: ReqBodyType) {
    const apiUrl = `${process.env.NEXT_PUBLIC_BASE_URL}${path}/${json.postId}`;
