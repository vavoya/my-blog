...
import {ReqBodyType, ResBodyType} from "@/app/api/client/me/about/type";
import {processApiResponse} from "@/fetch/utils/processApiResponse";
import {createAboutQuery} from "@/app/api/client/me/about/createQuery";

export default async function patchBySession(json: ReqBodyType) {
    const apiUrl = createAboutQuery();
