...
export default async function getByFolderId(userId: UserInfoResponse['_id'], folderId: FolderInfoResponse['_id'], pagenum: PageNumberResult['pageNumber']): Promise<Response<PaginatedPostsResponse[]>> {
