...
export type UserIdDocumentByAuthId = Pick<UserInfoDocument, '_id' | 'registration_state' | 'is_deleted'>
export type UserIdResponseByAuthId = Pick<UserInfoResponse, '_id' | 'registration_state' | 'is_deleted'>