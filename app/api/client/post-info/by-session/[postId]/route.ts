...
import patchByUserId from "@/services/server/post/patchByUserId/patchByUserId";
import {isShape} from "@/utils/isShape";
import {isConvertibleToDate} from "@/utils/isConvertibleToDate";
import {ResBodyType as PutResBodyType} from "@/app/api/client/post-info/by-session/[postId]/patch.type";
import {ResBodyType as DeleteResBodyType} from "@/app/api/client/post-info/by-session/[postId]/delete.type";
import deleteByUserId from "@/services/server/post/deleteByUserId/deleteByUserId";
 ...
 *
 * 요청 경로 예시:
 *   PATCH /api/client/post-info/by-session/abc123
 *
 * 요청 바디 예시:
 *   {
 ...
 *
 * 요청 경로 예시:
 *   DELETE /api/client/post-info/by-session/abc123
 *
 * 요청 바디 예시:
 *   {
